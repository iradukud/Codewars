...
function changeMe(moneyIn) {
    //return the right change for each coin inputted, if the coin is not in the object return it back  
    return {
        '£5': '20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p 20p',
        '£2': '20p 20p 20p 20p 20p 20p 20p 20p 20p 20p', '£1': '20p 20p 20p 20p 20p', '50p': '20p 20p 10p', '20p': '10p 10p'
    }[moneyIn] || moneyIn
}