...
function counterEffect(hitCount) {
    //returned an array with the original character replace by a subarray that goes from zero till the character 
    return [...hitCount].map(x => Array.from(({ length: +x + 1 }), (_, i) => i))
}