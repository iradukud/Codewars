...
function uncensor(infected, discovered) {
    //variable that will hold the fixed string
    let str = ''
    //loop that runs the length of the infected parameter and places the appropriate character into the created string
    for (i = 0, z = 0; i < infected.length; i++) {
        if (infected[i] == '*') {
            str += discovered[z]
            z++
        } else {
