...
function automorphic(n) {
    //took the last digits of n squared (length similar to n) and compared them
    //then returned a corresponding message
    return [...(n ** 2) + ''].slice((-1 * (n + '').length)).join('') == n ? 'Automorphic' : 'Not!!'
}