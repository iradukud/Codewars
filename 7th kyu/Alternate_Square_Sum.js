...
function alternateSqSum(arr) {
    ...
    //else return the sum of the odd indexed numbers square and even indexed numbers 
    return arr.filter((x, i) => i % 2).reduce((sum, num) => sum + num ** 2, 0) + arr.filter((x, i) => i % 2 == 0, 0).reduce((sum, num) => sum + num)
}