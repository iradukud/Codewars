...
function isSantaClausable(obj) {
    //for every required function/method checked if it exist in the object and whether its a function
    return ['sayHoHoHo', 'distributeGifts', 'goDownTheChimney'].every(methodName => typeof obj[methodName] == 'function')
}