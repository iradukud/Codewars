...
//Solution  
function countWins(winnerList, countr) {
    //returned the amount of winners from the winnerlist from the given country
    return winnerList.filter(x => x.country == countr).length
}