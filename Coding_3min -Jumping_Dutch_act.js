...
//answer    
function sc(floor) {
    //if the the floor is less or equal to 1 than return an empty string 
    //else if floor less than or equal 6 then return 'Pa! Aa!' at the end of 'Aa~ ' repeatitions
    //else return 'Pa!' at the end of 'Aa~ ' repeatitions
