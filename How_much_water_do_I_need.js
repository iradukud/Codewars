...
function howMuchWater(water, load, clothes) {
    // if the clothes is greater then the 2xload return specified message
    //else if the clothes is less than load return specified message 
    //else return the amount of water needed to wash the clothes
