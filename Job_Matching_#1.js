...
function match(candidate, job) {
    //if the values for the candidate and job exist then return a matched based on the values
    //else return an error
    return candidate.minSalary && job.maxSalary ? (candidate.minSalary) * 0.9 <= job.maxSalary : error
}