...
function makeValley(arr) {
    //variables that hold the left and right wings 
    const right = arr.sort((a, b) => b - a).filter((x, i) => i % 2).sort((a, b) => a - b)
    const left = arr.sort((a, b) => b - a).filter((x, i) => !(i % 2))
    //returned both the wings combined and sorted accordingly
