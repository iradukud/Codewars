...
function modifyMultiply(str, loc, num) {
    //variable that holds the picked word
    const picked = str.split(' ')[loc]
    //returned the picked word num time separated by a dash
    return Array.from({ length: num }, x => picked).join('-')
} 