...
//Solution    
function task(w, n, c) {
    //variable that holds the workers schedules
    const worker = { 'Monday': 'James', 'Tuesday': 'John', 'Wednesday': 'Robert', 'Thursday': 'Michael', 'Friday': 'William' }
    //returned the expected task for each employee on said day  
    return `It is ${w} today, ${worker[w]}, you have to work, you must spray ${n} trees and you need ${c * n} dollars to buy liquid`
}