...
function sabb(s, val, happiness) {
    //make s equal the amount/length of characters in s that are in the word Sabbatical
    s = (s.match(/[sabticl]/gi) || []).length
    //returned the corresponding string depending on whether the given parameters were sufficent
