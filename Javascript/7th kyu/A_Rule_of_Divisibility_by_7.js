...
seven(477557101) should return [28, 7]s
*/

//Solution    
const seven = m => {
    //variable that keeps count of the amount of times we tested
    let times = 0
    //loop that checks if m is divisible by 7
    while (('' + m).length > 2) {
        //increment counter
        times++
        //calcute m 
    ...
    //return the last m and the amount of times we ran the loop in an array
    return [m, times]
}