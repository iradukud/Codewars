...
function pendulum(values) {
    //variables that will hold parts of the givening values
    let arr1 = [] //even in the sorted values
    let arr2 = [] //odd in the sorted values
    //sort the given values and pushed each element to their corresponding arr
    values.sort((a, b) => a - b).map((v, i) => (i % 2 === 0 ? arr1 : arr2).push(v))
    //returned the final arr  
