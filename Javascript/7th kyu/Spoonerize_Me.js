...
function spoonerize(words) {
    //variable that holds the individual words as elements
    const sepWords = words.split(' ')
    //returned a string with the first characters of each word swapped
    return sepWords[1][0] + sepWords[0].slice(1) + ' ' + sepWords[0][0] + sepWords[1].slice(1)
}