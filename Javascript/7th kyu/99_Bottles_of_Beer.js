...
//Solution    
var sing = function () {
    // variable that will hold the array of the lyrics
    const lyrics = []
    //loop that places each line of lyric into the array till the 2nd last one
    for (i = 99; i >= 3; i--) {
    ...
    //returned the final lyrics + the last few lines
