...
function highestValue(a, b) {
    //returned the string with with the higher ASCII sum of it's characters
    return [...a].reduce((sum, char) => sum + +char.charCodeAt(0), 0) < [...b].reduce((sum, char) => sum + +char.charCodeAt(0), 0) ? b : a
}