...
function scoreTest(arr, right, omit, wrong) {
    //variable that holds an obj of the score for each correct and incorrect answer
    const obj = { '0': right, '1': omit, '2': -wrong }
    //returned the final score
    return arr.reduce((sum, num) => sum + obj[num], 0)
}