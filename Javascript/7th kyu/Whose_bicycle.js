...
function whoseBicycle(diary1, diary2, diary3) {
    //variable that holds the total score for each childs
    let arr = [Object.values(diary1), Object.values(diary2), Object.values(diary3)].map(v => v.reduce((a, b) => a + b, 0))
    //variable that holds the last index of the highest score
    let index = arr.lastIndexOf(Math.max(...arr))
    //returned string message of who gets the bike
